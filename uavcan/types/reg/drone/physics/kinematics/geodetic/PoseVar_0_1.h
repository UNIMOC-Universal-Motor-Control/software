...
// Source file:   C:\Projekte\unimoc\public_regulated_data_types\reg\drone\physics\kinematics\geodetic\PoseVar.0.1.uavcan
// Generated at:  2021-06-16 18:56:35.995055 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "C:\Projekte\unimoc\public_regulated_data_types\reg\drone\physics\kinematics\geodetic\PoseVar.0.1.uavcan is trying to use a serialization library that was compiled with "
    ...
    reg_drone_physics_kinematics_geodetic_PoseVar_0_1* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err2_ = reg_drone_physics_kinematics_geodetic_Pose_0_1_deserialize_(
