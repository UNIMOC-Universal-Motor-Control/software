...
// Source file:   C:\Projekte\unimoc\public_regulated_data_types\reg\drone\service\battery\Status.0.2.uavcan
// Generated at:  2021-06-16 18:56:36.511465 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "C:\Projekte\unimoc\public_regulated_data_types\reg\drone\service\battery\Status.0.2.uavcan is trying to use a serialization library that was compiled with "
    ...
    reg_drone_service_battery_Status_0_2* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err8_ = reg_drone_service_common_Heartbeat_0_1_deserialize_(
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err11_ = reg_drone_service_battery_Error_0_1_deserialize_(
