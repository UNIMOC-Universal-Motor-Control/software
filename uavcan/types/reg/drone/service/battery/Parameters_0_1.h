...
// Source file:   C:\Projekte\unimoc\public_regulated_data_types\reg\drone\service\battery\Parameters.0.1.uavcan
// Generated at:  2021-06-16 18:56:36.473567 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "C:\Projekte\unimoc\public_regulated_data_types\reg\drone\service\battery\Parameters.0.1.uavcan is trying to use a serialization library that was compiled with "
    ...
    const reg_drone_service_battery_Parameters_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // reg.drone.service.battery.Technology.0.1 technology
        ...
        int8_t _err20_ = reg_drone_service_battery_Technology_0_1_serialize_(
    ...
    reg_drone_service_battery_Parameters_0_1* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err22_ = uavcan_si_unit_mass_Scalar_1_0_deserialize_(
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err23_ = uavcan_si_unit_electric_charge_Scalar_1_0_deserialize_(
    ...
    for (size_t _index1_ = 0U; _index1_ < 2UL; ++_index1_)
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        {
            ...
            NUNAVUT_ASSERT(offset_bits % 8U == 0U);
            const int8_t _err24_ = uavcan_si_unit_voltage_Scalar_1_0_deserialize_(
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err25_ = uavcan_si_unit_electric_current_Scalar_1_0_deserialize_(
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err31_ = reg_drone_service_battery_Technology_0_1_deserialize_(
